            ...
            <form method="POST" action="/dokter/memeriksa/{{ $periksa->id }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="biaya_periksa" id="biaya_hidden" value="{{ $periksa->biaya_periksa }}">
                                </div>
                            </div>
                            <!-- /.card-body -->
    ...
    <script>
        $(function () {
            ...
            function calculateTotalBiaya() {
                ...
                // Format angka ke dalam format Rupiah (Rp xxx.xxx)
                const formatted = 'Rp ' + total.toLocaleString('id-ID');

                biayaInput.value = formatted;
                document.getElementById('biaya_hidden').value = total; // tetap simpan angka asli untuk dikirim ke backend
            }
